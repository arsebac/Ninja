package com.duckies.gdx.ninja.actor;
...
public class TilemapActor extends Actor {
    ...
    public TilemapActor(String filename, Stage stage) {
        ...
        tiledMapRenderer.setMaxTileSize(24, 24);
        tiledCamera = new OrthographicCamera();
        tiledCamera.setToOrtho(true, windowWidth, windowHeight);
        tiledCamera.update();
        tiledCamera.translate(new Vector2(150, 150));
        stage.addActor(this);
    }
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        tiledCamera.position.x = mainCamera.position.x - 50;
        tiledCamera.position.y = mainCamera.position.y - 50;
        tiledCamera.update();
